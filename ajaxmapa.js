...
var mymap = L.map('mapid').setView([22.22, -97.86], 13);
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoiZmVybmFuZG9ndWV2YXJhIiwiYSI6ImNrbmFxdjhucDE5bXEyc28wZWF4YXM2bHkifQ.fOh_Wsa1KnXlc_eqTxq0aQ'
}).addTo(mymap);
